...
--saveDataToFile(leftChestAmount + 1, rightChestAmount + 1)
--tp = component.getPrimary("transposer")



--leftChest = sides.left
--leftChestSize = tp.getInventorySize(leftChest)
--leftChessStackSize = 64

--while true do
--    for i = 1, leftChestSize do
--        tp.getSlotStackSize(leftChest, i)
--    end
--    print('1')
--
--    os.sleep(0.5)
